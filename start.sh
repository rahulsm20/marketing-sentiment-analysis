...
trap "echo 'Shutting down...'; kill $client_pid $scheduler_pid $scraping_pid $generation_pid $embedding_pid $db_pid; exit" SIGINT SIGTERM

# Wait for all
wait $client_pid $scheduler_pid $scraping_pid $generation_pid $embedding_pid $db_pid
